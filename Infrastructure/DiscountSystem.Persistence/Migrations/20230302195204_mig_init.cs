        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartDate = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValueSql: "GETDATE()"),
                    EndDate = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValueSql: "GETDATE()")
                },
                constraints: table =>
                {
